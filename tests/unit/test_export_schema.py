...
def test_export_cursor_round_trip_with_room_filter() -> None:
    cursor = ExportCursor(
        created_at=datetime(2026, 7, 1, 11, 30, 26),
        id=123,
        room_ids=(3, 8, 12),
    )
...
def test_export_cursor_normalizes_room_filter() -> None:
    cursor = ExportCursor(
        created_at=datetime(2026, 7, 1, 11, 30, 26),
        id=123,
        room_ids=(8, 3, 8),
